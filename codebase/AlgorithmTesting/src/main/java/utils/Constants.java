...
public class Constants {
	...
	public final static long NUMBER_OF_GRAPHS = 35;
	public final static long[] GRAPH_SIZE_LIST = {20};

	public final static int AVG_DEGREE = 3;
	public final static int AVG_DEGREE_WEIGHT = 3;
	
	public final static String[] COLOURS =  {"Blue", "Red", "Yellow", "Coral", "AntiqueWhite", "Aqua", "Aquamarine", 
		"Azure", "Beige", "Bisque", "Black", "BlanchedAlmond", "BlueViolet", "Brown", "BurlyWood", "CadetBlue", 
		"Chartreuse", "Chocolate", "CornflowerBlue", "Cornsilk", "Crimson", "Cyan", "DarkBlue", "DarkCyan", 
		...
		"Thistle", "Tomato", "Turquoise", "Violet", "Wheat", "White", "WhiteSmoke", "YellowGreen"};
}
